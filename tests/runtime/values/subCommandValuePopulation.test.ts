...
Deno.test("Option argument configured value is overridden by arg", () => {
  let command: SubCommand = {
    name: "command",
    options: [{
      name: "foo",
...
Deno.test("Option argument default value is overridden by configured value", () => {
  let command: SubCommand = {
    name: "command",
    options: [{
      name: "foo",
...
Deno.test("Option argument default value is overridden by arg", () => {
  let command: SubCommand = {
    name: "command",
    options: [{
      name: "foo",
...
Deno.test("Option argument configured value is used if no arg provided", () => {
  let command: SubCommand = {
    name: "command",
    options: [{
      name: "foo",
...
Deno.test("Interleaved option arrays", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "foo",
...
Deno.test("Illegal option syntax", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "foo",
...
Deno.test("Multiple positionals", () => {
  const command: SubCommand = {
    name: "command",
    options: [],
    positionals: [{
...
Deno.test("Multiple positional and varargs", () => {
  const command: SubCommand = {
    name: "command",
    options: [],
    positionals: [{
...
Deno.test("String options either side of positionals", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "goo1",
...
Deno.test("Boolean options either side of positionals", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "goo1",
...
Deno.test("Option array either side of positional", () => {
  let command: SubCommand = {
    name: "command",
    options: [{
      name: "foo",
...
Deno.test("Unused option after used option", () => {
  let command: SubCommand = {
    name: "command",
    options: [{
      name: "foo",
...
Deno.test("Unused option before used option", () => {
  let command: SubCommand = {
    name: "command",
    options: [{
      name: "foo",
...
Deno.test("Unused option after positional", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "foo1",
...
Deno.test("Unused option before positional", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "foo1",
...
Deno.test("Unused positional after positional", () => {
  const command: SubCommand = {
    name: "command",
    options: [],
    positionals: [{
...
Deno.test("Unused positional after optional", () => {
  let command: SubCommand = {
    name: "command",
    options: [{
      name: "foo",
...
Deno.test("Positionals either side of options", () => {
  let command: SubCommand = {
    name: "command",
    options: [{
      name: "goo1",
...
Deno.test("Positionals and non-boolean options interleaved", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "goo1",
...
Deno.test("Positionals and boolean options interleaved", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "goo1",
...
Deno.test("Array option before vararg positional", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "foo",
...
Deno.test("Vararg positional before array option", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "foo",
...
Deno.test("Positional types configured value is overridden by arg", () => {
  let command: SubCommand = {
    name: "command",
    options: [],
    positionals: [{
...
Deno.test("Positional types configured value is used for optional vararg with no arg provided", () => {
  let command: SubCommand = {
    name: "command",
    options: [],
    positionals: [{
...
Deno.test("Positional types configured value is used for mandatory vararg with no arg provided", () => {
  let command: SubCommand = {
    name: "command",
    options: [],
    positionals: [{
...
Deno.test("Option array configured single values completely overridden by multiple args", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "foo",
...
Deno.test("Option array configured multiple values partially overridden by arg", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "foo",
...
Deno.test("Positional argument configured single value completely overridden by multiple args", () => {
  const command: SubCommand = {
    name: "command",
    options: [],
    positionals: [{
...
Deno.test("Positional argument configured multiple values partially overridden by single arg", () => {
  const command: SubCommand = {
    name: "command",
    options: [],
    positionals: [{
...
Deno.test("Option array using indices", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "foo",
...
Deno.test("Option array invalid indices", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "foo",
...
Deno.test("Option array missing indices populated by configured defaults", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "foo",
...
Deno.test("Option array using indices either side of positional", () => {
  let command: SubCommand = {
    name: "command",
    options: [{
      name: "foo",
...
Deno.test("Option complex values", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "alpha",
...
Deno.test("Option arrays of complex values and vice versa", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "alpha",
...
Deno.test("Option complex values with invalid properties", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "alpha",
...
Deno.test("Option array check for maximum array size", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "foo",
...
Deno.test("Option array using mix of explicit and implicit indices", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "foo",
...
Deno.test("Positional varargs check for maximum array size", () => {
  const command: SubCommand = {
    name: "command",
    options: [],
    positionals: [{
...
Deno.test("Option path invalid reference to complex option", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "alpha",
...
Deno.test("Complex options with duplicated names and aliases ok if not siblings", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "alpha",
...
Deno.test("Option path check for maximum nesting", () => {
  const command: SubCommand = {
    name: "command",
    options: [{
      name: "alpha",
