...
Deno.test("Arguments parsed for sub-command", () => {
...
Deno.test("Quoted string parsing works", () => {
  const subCommand = getSubCommandWithOptionAndPositional();
...
Deno.test("Arguments parsed for global command", () => {
...
Deno.test("Arguments parsed for global modifier command", () => {
...
Deno.test("Arguments parsed with trailing args", () => {
  const subCommand = getSubCommandWithOptionAndPositional();
...
Deno.test("All arguments provided in config", () => {
  const subCommand = getSubCommandWithOptionAndPositional();
...
Deno.test("Some arguments provided in config", () => {
  const subCommand = getSubCommandWithOptionAndPositional();
...
Deno.test("Extra config provided", () => {
  const subCommand = getSubCommandWithOptionAndPositional();
...
Deno.test("Arguments parsed for sub-command with complex options", () => {
...
Deno.test("Arguments parsed for sub-command with complex options (illegal scenarios)", () => {
...
Deno.test("Arguments parsed for sub-command with complex options and sparse array", () => {
  const subCommand = getSubCommandWithComplexOptions(false, true);
...
Deno.test("Arguments parsed for sub-command with complex options and missing property values", () => {
...
Deno.test("Arguments parsed for sub-command with complex options and some values provided by config", () => {
  const subCommand = getSubCommandWithComplexOptions(false, true);
...
Deno.test("Arguments parsed for sub-command with complex options and some values provided by config but overridden", () => {
  const subCommand = getSubCommandWithComplexOptions(false, true);
...
Deno.test("Arguments parsed for sub-command with complex options and all values provided by config", () => {
  const subCommand = getSubCommandWithComplexOptions(false, true);
...
Deno.test("Arguments parsed for sub-command with complex options and all values provided by default value", () => {
