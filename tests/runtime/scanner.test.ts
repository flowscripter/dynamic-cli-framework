...
describe("scanner", () => {
  ...
  it("Unused leading args whilst scanning for global modifier command", () => {
    const globalModifierCommand = getGlobalModifierCommand(
      "modifier",
      "m",
      true,
  ...
  it("Unused leading args whilst scanning for non-modifier command", () => {
    const globalCommand = getGlobalCommandWithShortAlias("globalCommand", "g");
    const subCommand = getSubCommandWithOptionAndPositional();
  ...
  it("Global command normalising (tricky scenario 1)", () => {
    const globalCommand = getGlobalCommandWithShortAlias("globalCommand", "g");
  ...
  it("Global command normalising (tricky scenario 2)", () => {
    const globalCommand = getGlobalCommandWithShortAlias("globalCommand", "g");
  ...
  it("Two sub-commands specified (illegal scenario)", () => {
    const subCommand = getSubCommandWithOptionAndPositional();
    const nonModifierCommandsByName: ReadonlyMap<string, Command> = new Map([
      [subCommand.name, subCommand],
    ]);
  ...
  it("Global command and sub-command scanned (illegal scenario)", () => {
    const globalCommand = getGlobalCommandWithShortAlias("globalCommand", "g");
    const subCommand = getSubCommandWithOptionAndPositional();
    const nonModifierCommandsByName: ReadonlyMap<string, Command> = new Map([
      [subCommand.name, subCommand as Command],
  ...
  it("Group command and sub-command scanned (illegal scenario)", () => {
    const subCommand = getSubCommandWithOptionAndPositional();
    const groupCommand = getGroupCommand("group", [subCommand]);
    const nonModifierCommandsByName: ReadonlyMap<string, Command> = new Map([
      [subCommand.name, subCommand as Command],
