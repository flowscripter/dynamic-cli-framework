...
describe("SyntaxHighlighterServiceProvider", () => {
  it("SyntaxHighlighterServiceProvider provide and initService works", async () => {
    ...
    context.addServiceInstance(
      PRINTER_SERVICE_ID,
      new DefaultPrinterService(buffer, buffer),
    );
